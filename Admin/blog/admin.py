...
"""
    ...
    ✅ class XXXAdamin ( 설정 클래스 )
    ✅ admin.site.register(모델명, XXXAdamin)
...
#     # ⭐ 메소드 이름 : 출력 필드 이름과 동일하게 설정(user_nickname)
...
#     post_created_at.short_description = '등록일'
...
class PostAdmin(admin.ModelAdmin):
    # 출력 필드 설정
    list_display = (
        'is_public','post_title', 'user_username', 'user_nickname', 
